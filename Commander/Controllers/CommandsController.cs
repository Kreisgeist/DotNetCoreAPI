...
namespace Commander.Controllers
{
    ...
    public class CommandsController : ControllerBase
    {
        ...
        //POST api/commands
        [HttpPost]
        public ActionResult<CommanderReadDto> CreateCommand(CommandCreateDto commandCreateDto)
        {
        ...
        {
            //Verificamos que el elemento a parchar exista
            var commandModelFromRepo = _repository.GetCommandById(id);
            if (commandModelFromRepo == null)
            {
                return NotFound();
            ...
            //Lo mapeamos al tipo de DTO para hacer update
            var commandToPatch = _mapper.Map<CommandUpdateDto>(commandModelFromRepo);
            //Aplicamo el parche
            patchDoc.ApplyTo(commandToPatch, ModelState);
            //Validamos que el modelo se guarde correctamente
